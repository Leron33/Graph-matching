...
This repository is the implementation of "SeedGNN: Graph Neural Networks for Supervised Seeded Graph Matching" by Liren Yu, Jiaming Xu and Xiaojun Lin. 
...
* To evaluate our model on ER graphs and generate the results for Fig.2 in our paper, run:
...
----------------------------------------
* To evaluate our model on the Shrec'16 dataset and generate the results for Fig.3 in our paper, run:
...
* To evaluate our model on Facebook networks and generate the results for Fig.4 in our paper, run:
...
* To verify the effectiveness of our design choices and generate the results for Fig.5 in our paper, run:
...
* To verify the necessary training samples for generalization and generate the results for Fig.6 in our paper, run:
...
* To generate the layer-wise matching results for Fig.7 and Fig.8 in our paper, run:
